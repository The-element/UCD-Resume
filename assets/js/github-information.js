...
function fetchGitHubInformation(event) {    //Is being called when writing in the input-text-form.
    ...
    $.when( //When the following code has run,
        ...
        function(response) {    //if we get a respons, pass in the response to this function, and do the following:
            var userData = response; //store the response in the variable userData.
